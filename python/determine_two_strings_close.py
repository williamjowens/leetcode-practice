...
example1 = solution.closeStrings("abc", "bca")
example2 = solution.closeStrings("a", "aa")
example3 = solution.closeStrings("cabbba", "abbccc")

print(f"Example 1: {example1}, Example 2: {example2}, Example 3: {example3}")